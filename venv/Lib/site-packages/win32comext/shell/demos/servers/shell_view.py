...
class FileSystemView:
   ...
   # IShellView
    ...
    def _CreateMainWindow(self, prev, settings, browser, rect):
        ...
        self.hwnd = win32gui.CreateWindow( wclass_name, "", style, rect[0], rect[1], rect[2]-rect[0], rect[3]-rect[1],
...
def DllRegisterServer():
    ...
    key = winreg.CreateKey(winreg.HKEY_LOCAL_MACHINE,
                            "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\" "Explorer\\Desktop\\Namespace\\" + ShellFolderRoot._reg_clsid_)
