...
class DebugCodeContext(gateways.DebugCodeContext, gateways.DebugDocumentContext):
    ...
    _public_methods_ = gateways.DebugCodeContext._public_methods_ + gateways.DebugDocumentContext._public_methods_
    _com_interfaces_ = gateways.DebugCodeContext._com_interfaces_ + gateways.DebugDocumentContext._com_interfaces_
