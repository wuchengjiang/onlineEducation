...
class AXScriptException(win32com.server.exception.COMException):
	...
	def __init__(self, site, codeBlock, exc_type, exc_value, exc_traceback):
		...
		win32com.server.exception.COMException.__init__( self, description = "Unknown Exception", scode = winerror.DISP_E_EXCEPTION, source = "Python ActiveX Scripting Engine",
			)
