...
domain_name,dns_domain_name, dns_forest_name, domain_guid, domain_sid = win32security.LsaQueryInformationPolicy(policy_handle,win32security.PolicyDnsDomainInformation)
